  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${recipe.tags.join(", ")}, ${
            recipe.category
          }, healthy recipe, nutrition`}
        />

        {/* Open Graph / Facebook */}
        <meta
          property="og:title"
          content={`${recipe.title} - Whole Bite Nutrition`}
        />
        ...
        <meta
          property="og:url"
          content={`https://www.whole-bite.com/recipes/${recipe.id}`}
        />
        ...
        <meta name="author" content="Isabel Diez - Whole Bite Nutrition" />
        <link
          rel="canonical"
          href={`https://www.whole-bite.com/recipes/${recipe.id}`}
        />
      </Helmet>

      {/* Structured Data for Recipe */}
      <StructuredData type="recipe" recipe={recipe} />
          ...
          >
                ...
                <Row gutter={[32, 32]}>
                    ...
                    <div className="relative overflow-hidden rounded-2xl group">
                      ...
                      <div className="absolute top-4 left-4">
                        <div className="flex gap-2">
                          <Tag
                            className="rounded-full font-semibold px-3 py-1 text-sm backdrop-blur-sm bg-white/90"
                            style={{
                  ...
                  <Col xs={24} lg={12}>
                    <div className="h-full flex flex-col justify-center p-4">
                      <Title
                        level={1}
                        className="mb-4 text-3xl lg:text-4xl font-bold bg-gradient-to-r from-emerald-700 to-green-600 bg-clip-text text-transparent"
                      >
                        {recipe.title}
                      </Title>
                      ...
                      renderItem={(item: string, index: number) => (
                        <List.Item className="border-0 px-0 py-3 hover:bg-white/50 rounded-lg transition-all duration-200">
                          <div className="flex items-start w-full px-2">
                            ...
                            <Text className="text-gray-700 font-medium leading-relaxed">
                              {item}
                            </Text>
                          </div>
                        </List.Item>
                ...
                <Row gutter={[16, 16]}>
                  ...
                  <Col xs={12} sm={6}>
                    <div className="text-center p-5 rounded-2xl bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200/50">
                      <div
                        className="w-10 h-10 mx-auto mb-2 rounded-full flex items-center justify-center shadow-lg"
            ...
            >
              <Card className="mt-8 shadow-xl rounded-2xl border-0 bg-gradient-to-br from-emerald-50/50 to-green-50/50 backdrop-blur-sm">
                <Title
                  level={4}
                  className="mb-6 text-xl font-bold flex items-center"
                  style={{ color: "#065f46" }}
                >
                  <div className="w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center mr-3 shadow-lg">
                    <FontAwesomeIcon
