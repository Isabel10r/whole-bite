...
const SimpleEmailModal: React.FC<SimpleEmailModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit to Google Forms
      await fetch(
        "https://docs.google.com/forms/d/e/1FAIpQLSdDJuM7nPKD5sUPoMtigBLm8VVbS6GOUYk9DrDQS21-Sn6taA/formResponse",
        {
          method: "POST",
          body: formData,
          ...
          <>
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-base text-black mb-3">
                Enter your email to schedule your personalized nutrition
                consultation
              </p>
            </div>
