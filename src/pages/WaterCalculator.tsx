...
const WaterCalculator: React.FC = () => {
  ...
  const calculateWaterIntake = async (values: any) => {
    ...
    try {
      ...
      const climateData = climateConditions.find(condition => condition.value === climate);
      if (!climateData) {
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12 relative z-10">
          ...
          <div className="text-center mb-16">
            <motion.h1 
              ...
              style={{ color: '#2E2E2E' }}
            >
              <FontAwesomeIcon icon={faTint} className="mr-4 text-[#10b981]" />
            ...
            <motion.p 
              ...
              style={{ color: '#2E2E2E' }}
            >
              Calculate your daily hydration needs based on scientific evidence from EFSA and National Academies of Sciences
            </motion.p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <Form.Item
                    label={
                      <span>
                        <FontAwesomeIcon icon={faInfoCircle} className="mr-2 text-[#f39c12]" />
                        Climate Conditions
                      </span>
                    }
                    name="climate"
                    rules={[{ required: true, message: 'Please select your climate condition' }]}
                  >
                    <Select 
                    ...
                    >
                      {climateConditions.map((condition) => (
                        ...
                        >
                          <div className="py-2 px-1">
                            <div className="font-medium text-sm leading-tight mb-1">{condition.label}</div>
                            <div className="text-xs text-gray-500 leading-relaxed">{condition.description}</div>
                          </div>
                        </Option>
                      ))}
                    </Select>
                ...
                {loading ? (
                  ...
                  <Space direction="vertical" size="large" className="w-full">
                        ...
                        >
                          <div className="mb-3">
                            <div className="w-12 h-12 rounded-full bg-[#e74c3c]/10 flex items-center justify-center mx-auto mb-2">
                              <FontAwesomeIcon icon={faTint} className="text-xl text-[#e74c3c]" />
                            </div>
                    ...
                    >
                      <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 rounded-full bg-[#f39c12]/10 flex items-center justify-center">
                          <FontAwesomeIcon icon={faTint} className="text-[#f39c12] text-lg" />
                        </div>
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        <Text strong style={{ color: '#2E2E2E' }}>Morning (6 AM - 12 PM)</Text>
                        <Text className="text-lg font-semibold" style={{ color: '#2E2E2E' }}>
                      ...
                      >
                        <Text strong style={{ color: '#10b981' }}>Afternoon (12 PM - 6 PM)</Text>
                      ...
                      >
                        <Text strong style={{ color: '#24604c' }}>Evening (6 PM - 10 PM)</Text>
                        <Text className="text-lg font-semibold" style={{ color: '#24604c' }}>
                  ...
                  <div className="text-center py-8">
                    ...
                    <Text type="secondary">
                      Fill out the form to calculate your daily water intake needs
                    </Text>
                  </div>
                )}
                </Card>
          ...
          >
            <Row gutter={[24, 24]} className="mt-8">
              <Col xs={24} md={12}>
                ...
                >
                  <Paragraph>
                    <Text strong style={{ color: '#2E2E2E' }}>Proper hydration</Text> is essential for maintaining optimal health and bodily functions. Water plays a crucial role in temperature regulation, nutrient transport, joint lubrication, and waste removal.
                  </Paragraph>
                  <Paragraph>
                    The human body is approximately 60% water, and even mild dehydration can affect cognitive function, physical performance, and overall well-being.
                  </Paragraph>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                ...
                >
                  <Paragraph>
                    <Text strong style={{ color: '#2E2E2E' }}>Our calculation</Text> is based on scientific evidence from the European Food Safety Authority (EFSA) and National Academies of Sciences, Engineering, and Medicine.
                  </Paragraph>
                  <Paragraph>
                    The formula considers: weight (30-50ml per kg), activity level, and climate conditions to provide personalized hydration recommendations.
                  </Paragraph>
                </Card>
              </Col>
            </Row>
